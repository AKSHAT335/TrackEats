...
const Welcome = ({ nextStep }: propType) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 from-green-50 to-white">
      <motion.div
      ...
      <motion.p
        ...
        transition={{ duration: 0.6 }}
      >
        Your Food Delivery Companion - Fresh, Fast, and Reliable!
      </motion.p>
      <motion.div
