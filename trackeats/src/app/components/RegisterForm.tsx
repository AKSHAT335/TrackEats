...
const RegisterForm = ({ prevStep }: propType) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
      <div
        className="absolute top-6 left-6 flex items gap-2 text-green-700 hover:text-green-800  transition-colors cursor-pointer"
        onClick={() => prevStep(1)}
      >
      ...
      <p className="text-gray-600 mb-8 flex items-center">
        Join TrackEats today <Leaf className="w-5 h-5 text-green-600" />
      </p>
